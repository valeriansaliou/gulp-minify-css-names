...
describe('gulp-minify-cssnames', function() {
    describe('Replace CSS names', function() {
        ...
        it('Should work with buffer (alternative buster)', function(done) {
            var stream = minify({method: 'hash-weak', buster: 'a1hdo'});
            var file = new File({
                path: 'test/fixtures/style.alt-buster.css',
                cwd: 'test/',
                base: 'test/fixtures',
                contents: fs.readFileSync('test/fixtures/style.alt-buster.css')
            });
        ...
        it('Should work with stream (alternative buster)', function(done) {
            var stream = minify({method: 'hash-weak', buster: 'a1hdo'});
            var file = new File({
                path: 'test/fixtures/style.alt-buster.css',
                cwd: 'test/',
                base: 'test/fixtures',
                contents: fs.createReadStream('test/fixtures/style.alt-buster.css')
            });
